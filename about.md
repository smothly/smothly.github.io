...
<br><br>
- **Python Library**: Sckit learn, Keras, Pytorch, Pandas, Numpy<br><br>
- **Development Environment**: Docker, Git<br><br>
- **WEB Programming**: Ruby on Rails, Django<br><br>
- **Certification**: SQLD, 정보처리기사<br><br>
